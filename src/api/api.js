...
* */
  ...
  * */
  weiJingAuth(params) {
    return axios.get('/wxInterface/miniProgram/getCertToken', {
      params: {
  ...
  validateCertToken(params) {
    return axios.get('/wxInterface/miniProgram/validateCertToken', {
      params: {
  ...
  getOpenIdFromCache(params) {
    return axios.get('/wxInterface/miniProgram/getOpenIdFromCache', {
      params: {
        certToken: params.certToken
      }
    })
  ...
  */
  ...
  loginLaisui(params) {
    return axios.post('/wxInterface/miniProgram/loginLaisui', qs.stringify({
      openId: params.openId,
      account: params.account,
  ...
  querySmhsszList(params) {
    return xhr.get('https://zwt.createt.cn/gzGovTong/mobile/laisuiQuerySmhsszList', {
      params: {
        openid: params.openid,
        opentype: '2',
        jz: params.jz,
  ...
  laisuiQueryYyszList(params) {
    return xhr.get('https://zwt.createt.cn/gzGovTong/mobile/laisuiQueryYyszList', {
      params: {
        openid: params.openid,
        opentype: '2',
        jz: params.jz,
   ...
   */
  queryRHKT(params) {
    return xhr.post("/wxInterface/course/getCourseList", qs.stringify({
      openId: params.openId,
      page: params.page,
      limit: params.limit,
      auditStatus: 1
   ...
   */
  queryRHKTArt(params) {
    return xhr.post("/wxInterface/course/getCourseDetail", qs.stringify({
      openId: params.openId,
   ...
   */
  queryDJHD(params) {
    return xhr.post("/wxInterface/partyDevelop/getPartyDevelopList", qs.stringify({
      openId: params.openId,
      page: params.page,
      limit: params.limit,
      auditStatus: 1
   ...
   */
  queryRHHD(params) {
    return xhr.post("/wxInterface/activity/getActivityList", qs.stringify({
      openId: params.openId,
      page: params.page,
      limit: params.limit,
      auditStatus: 1
   ...
   */
  queryNEWSHot(params) {
    return xhr.post("/wxInterface/information/getInformationList", qs.stringify({
      pageSize: params.pageSize,
  ...
  */
  queryNEWSArt(params) {
    return xhr.post("/wxInterface/information/getInformationById", qs.stringify({
  ...
  */
  clickZan(params) {
    return xhr.post("/wxInterface/information/userLikeInformation", qs.stringify({
      informationId: params.informationId,
      openId: params.openId
  ...
  */
  clickZanHD(params) {
    return xhr.post("/wxInterface/partyDevelop/partyDevelopLike", qs.stringify({
  ...
  */
  trafficStatisticsDJ(params) {
    return xhr.post("/wxInterface//partyDevelop/statsPartyDevelop", qs.stringify({
      id: params.id,
    }))
  },
  ...
  */
  queryDjHdArt(params) {
    return xhr.post("/wxInterface/partyDevelop/getPartyDevelopDetail", qs.stringify({
      partyDevelopId: params.partyDevelopId,
      openId: params.openId
  ...
  */
  queryRhHdArt(params) {
    return xhr.post("/wxInterface/activity/getactivityDetail", qs.stringify({
  ...
  */
  DJApply(params) {
    return xhr.post("/wxInterface/partyDevelop/signForPartyDevelop", qs.stringify({
      partyDevelopId: params.partyDevelopId,
      openId: params.openId,
      phone: params.phone
  ...
  */
  RHApply(params) {
    return xhr.post("/wxInterface/activity/signForactivity", qs.stringify({
      activityId: params.activityId,
      openId: params.openId,
      phone: params.phone
  ...
  */
  requireNewsTab(params) {
    return xhr.post("/wxInterface/information/getInformationSeggust", qs.stringify({
    }))
  },
  /*资讯分类展示列表
    *  seggustId:类目ID
  ...
  */
  requireNewsTabLists(params) {
    return xhr.post("/wxInterface/information/getSeggustInformationList", qs.stringify({
  ...
  */
  requireIndexsSwiper(params) {
    return xhr.post("/wxInterface/information/getTopInformationList", qs.stringify({
      pageSize: params.pageSize,
      pageNum: params.pageNum,
    }))
  },
  ...
  */
  requireNewsSwiper(params) {
    return xhr.post("/wxInterface/informationBanner/getBannerList", qs.stringify({
      pageSize: params.pageSize,
      pageNum: params.pageNum,
    }))
  },
  ...
  */
  requireDYmsg(params) {
    return xhr.post("/wxInterface/partyDevelop/getMemberMsg", qs.stringify({
      openId: params.openId,
    }))
  },
  ...
  */
  requireSJlist(params) {
    return xhr.post("/wxInterface/event/getEventList", qs.stringify({
      openId: params.openId,
  ...
  */
  reportSJ(params) {
    return xhr.post("/wxInterface/event/saveEvent", qs.stringify({
      openId: params.openId,
  ...
  */
  delPic(imgId) {
    return xhr.post(`/wxInterface/sysFile/deleteFile?title="${imgId}`)
    //
  },
  /*
   *  获取短信验证码接口
   ...
   * */
  sendMessage(params) {
    return xhr.post('/wxInterface/miniProgram/sendMessage', qs.stringify({
      openId: params.openId,
      phone: params.phone
    }))
  },
   ...
   * */
  logOut(params) {
    return xhr.post('/wxInterface/miniProgram/logOut', qs.stringify({
      openId: params.openId,
    }))
  },
  /*
   ...
   * */
  retrievalPW(params) {
    return xhr.post('/wxInterface/miniProgram/findPassword', qs.stringify({
      openId: params.openId,
   ...
   * */
  changePW(params) {
    return xhr.post('/wxInterface/miniProgram/updatePassword', qs.stringify({
      openId: params.openId,
   ...
   * */
  saveUser(params) {
    return xhr.post('/wxInterface/miniProgram/registLaisui', qs.stringify({
      openId: params.openId,
      name: params.name,
 ...
 *  */
  setUpPicSSP(params) {
    return xhr.post('/wxInterface/sysFile/saveBase64Img', qs.stringify({
...
unionid 只有在用户将公众号绑定到微信开放平台帐号后，才会出现该字段。m password 密码
   * */
  getWXdUser(params) {
    return axios.post('/wxInterface/wxUser/checkUser', qs.stringify({
      openId: params.openId,
    }))
  },
  /*
   ...
   * */
  checkUser(params) {
    return xhr.post('/wxInterface/miniProgram/checkLaisuiRegistStatus', qs.stringify({
      openId: params.openId,
      identity: params.identity,
    }))
  },
 ...
 * @param  totalAmount(缴费总金额)
   * */
  saveSBMsg(params) {
    return xhr.post('/wxInterface/socialSecurity/saveSocialSecurityInfomation', qs.stringify(params))
  },
  ...
  */
  saveResidencePermit(params) {
    return xhr.post('/wxInterface/residencePermit/saveResidencePermit', qs.stringify(params))
  },
  /*
 * 接口名称:预约窗口保存居住证登记信息到越秀后台
 */
  reservationSave(params) {
    return xhr.post('/wxInterface/residencePermitReservation/save', qs.stringify(params))
  },
  /*
* 请求图南居住证通用接口
*/
  tunansendPost(params) {
    return xhr.post('/wxInterface/residencePermit/sendPost', qs.stringify({
  ...
  */
  getEventArt(params) {
    return xhr.post('/wxInterface/event/getEventById', qs.stringify({
      id: params.id,
    }))
  },
  /**房屋租赁备案接口 */
  ...
  */
  recordList(params) {
    return xhr.post('/wxInterface/hRecord/recordList', qs.stringify({
      openId: params.openId
    }))
  },
    /** 房东查询房屋备案列表 2019219 
  ...
  */
   ...
   *
  */
  recordListNewZK(params) {
    return xhr.post('/wxInterface/hRecord/recordHirerList', qs.stringify({
      openId: params.openId,
      page: params.page,
      limit: params.limit
    }))
   ...
   */
  dataRevoke(params) {
    return xhr.post('/wxInterface/hRecord/dataRevoke', qs.stringify({
      hrId: params.hrId
    }))
  },
   ...
   */
  dataRevokeZK(params) {
    return xhr.post('/wxInterface/hRecord/hRecordHirerRevoke', qs.stringify({
      hrId: params.hrId
    }))
  },
   ...
   */
  wxUser(params) {
    return xhr.post('/wxInterface/hRecord/wxUser', qs.stringify({
      openId: params.openId
    }))
  },
  /**
   ...
   */
  purpose() {
    return xhr.post('/wxInterface/hRecord/purpose')
  },
  /**
   * 地区接口(4-7级)
   * level 层级 4-7
  ...
  */
  area(params) {
    return xhr.post('/wxInterface/hRecord/area', qs.stringify({
      level: params.level,
      typeCode: params.typeCode
    }))
  },
...
timeEndStr  开始时间 格式 yyyy-MM-dd
   */
  databack(params) {
    return xhr.post('/wxInterface/hRecord/databack', qs.stringify({
      hrId: params.hrId
    }))
  },
  /**
 ...
 * uploadFile */
  uploadFile(params) {
    return xhr.post('/wxInterface/hRecord/uploadFile', qs.stringify({
      pId: params.pId,
  ...
  * uploadFile */
  fileUrl(params) {
    return xhr.post('/wxInterface/hRecord/fileUrl', qs.stringify({
      fId: params.fId
    }))
  },
  /**
   ...
   * uploadFile */
  fileReplace(params) {
    return xhr.post('/wxInterface/hRecord/fileReplace', qs.stringify({
      pId: params.pId,
      fileType: params.fileType,
      file: params.file,
      fId: params.fId
   ...
   * uploadFile */
  deleteFile(params) {
    return xhr.post('/wxInterface/hRecord/deleteFile', qs.stringify({
      fId: params.fId
    }))
  },
  ...
  * uploadFile */
  hrecordSub(params) {
    return xhr.post('/wxInterface/hRecord/hrecordSub', qs.stringify({
      hrId: params.hrId
    }))
  },
  /**
   ...
   * uploadFile */
  areaDetail(params) {
    return xhr.post('/wxInterface/hRecord/areaDetail', qs.stringify({
  ...
  feedbackSubmit(params) {
    return axios.post('/wxInterface/helpFeedback/feedBack', qs.stringify({
      title: params.title,
  ...
  setUpPicHELP(params) {    //
    return axios.post('/wxInterface/helpFeedback/uploadFbPic', qs.stringify({
      openId: params.openId,
      file: params.file,
   ...
   **/
  delUpPic(fid) {
    return axios.post(`/wxInterface/helpFeedback/delPic?fId=${fid}`);
  },
  ...
  * 住证登记用户个人反馈历史
   */
  requireMyQ(params) {
    return axios.post('/wxInterface/helpFeedback/feedBackList', qs.stringify({
      page: params.page,
      size: params.size,
      openId: params.openId,
    })
  ...
  * 住证登记用户个人反馈问题详情
   */
  myQArticle(comGUID) {
    return axios.post(`/wxInterface/helpFeedback/feedBackdetail?comGUID=${comGUID}`);
  ...
  * 住证登记常见问题
   */
  requireQ(params) {
    return axios.post('/wxInterface/helpFeedback/helplist', qs.stringify({
      page: params.page,
      size: params.size,
    })
    )
  ...
  * 住证登记用户热门问题详情
   */
  hotArticle(comGUID) {
    return axios.post(`/wxInterface/helpFeedback/helpdetail?comGUID=${comGUID}`);
  },
  /**用户标签接口 */
   ...
   */
  indexTitle(openId) {
    return axios.get(`/recommend/indexTitle?openId=${openId}`);
  },
  /**
   *单个用户全部标签接口
   *@param {*} openId
   */
  userTitle(openId) {
    return axios.get(`/recommend/userTitle?openId=${openId}`);
  },
  /**
   *本接口用于用户登陆时给其打上相应标签
   * @param {*} openId
  ...
  saveLoginTitle(openId) {
    return axios.get(`/recommend/saveLoginTitle?openId=${openId}`);
  },
  /**
  ...
  saveUserBehaviourTitle(openId, id) {
    return axios.get(`/recommend/saveLoginTitle?openId=${openId}&id=${id}`);
  },
  /**
   * 资讯埋点打标接口
   * openId  微信id
  ...
  saveUserInformationTitle(openId, id, type) {
    return axios.get(`/recommend/saveUserInformationTitle?openId=${openId}&id=${id}&type=${type}`);
  },
  /**
   * 融合活动埋点打标接口
   * 资讯埋点打标接口
  ...
  saveUserActivityTitle(openId, id, type) {
    return axios.get(`/recommend/saveUserActivityTitle?openId=${openId}&id=${id}&type=${type}`);
  },
  /**
  * 党建活动埋点打标接口
  * 资讯埋点打标接口
  ...
  */
  saveUserPartyDevelopTitle(openId, id, type) {
    return axios.get(`/recommend/saveUserPartyDevelopTitle?openId=${openId}&id=${id}&type=${type}`);
  },
  /**
   * 融合学堂埋点打标接口
  ...
  saveUserCourseTitle(openId, id, type) {
    return axios.get(`/recommend/saveUserCourseTitle?openId=${openId}&id=${id}&type=${type}`);
  },
  /**
   * 个性化推荐接口
  ...
  privateRecommend(openId, page, size) {
    return axios.get(`/recommend/privateRecommend?openId=${openId}&page=${page}&size=${size}`);
  },
  /**接口名称:房屋备案登记(房东填)   新
   * 接口地址:ip:port/项目名/wxInterface/hRecord/saveOrUpdateHRecord
   * email:chenmc@createw.com
   * @param openId(微信openId)
   * @param id(*可传,若有则代表更新数据)
   * @param agreeNo(合同编号)
   * @param houseAddress(房屋地址)
   * @param houseArea(房屋面积)
   * @param rentPrice(租金)
   * @param purpose(租赁用途)
   * @param limitTimeStart(租赁期限开始时间)
   * @param limitTimeEnd(租赁期限结束时间)
   * @param renter(出租人姓名)
   * @param rentNo(出租人身份证号码)
   * @param cardPhoto(身份证照片)
   * @param sex(性别)
   * @param phone(电话号码)
   * @param streetNo(街镇)
   * @param streetLaneNo(街道巷)
   * @param doorNo(门牌号)
   * @param roomNo(房号)
   * @param certificate(不动产权证号)
   **/
  referLeaseRecord (params) {
    return axios.post('/wxInterface/hRecord/saveOrUpdateHRecord', qs.stringify({
      openId: params.openId,
      id: params.id, 
      agreeNo: params.agreeNo,
      ...
      limitTimeStart: params.limitTimeStart,
      limitTimeEnd: params.limitTimeEnd,
      renter: params.renter,
      rentNo: params.rentNo,
      cardPhoto: params.cardPhoto,
      sex: params.sex,
      phone: params.phone,
      streetNo: params.streetNo,
      streetLaneNo: params.streetLaneNo,
      doorNo: params.doorNo,
      roomNo: params.roomNo,
      certificate: params.certificate,
      cardPhoto: params.cardPhoto,
      hirerJson: params.hirerJson       
    })
    )
  },
/**接口名称:查询房屋租赁备案(房东)
 * 接口地址:ip:port/项目名/wxInterface/hRecord/getById
 * @param id
**/
  queryLeaseRecord (params) {
    return axios.post('/wxInterface/hRecord/getById', qs.stringify({
      id: params.id, 
    })
    )
  },
   ...
   * @param sex(性别)
   * @param phone(电话)
   * @param hrId(租赁备案Id,房东将备案号给租客让租客填)
   * @param email(电子邮箱)
   **/
  referRenting (params) {
    return axios.post('/wxInterface/hRecord/saveOrUpdateHRecordHirer', qs.stringify({
      openId: params.openId,
      photo: params.photo,
...
 * @param id
**/
  queryLeaseRecordZK (params) {
    return axios.post('/wxInterface/hRecord/getHirerById', qs.stringify({
      id: params.id, 
    })
    )
  },
/**接口名称:提交房屋租赁备案(房客)
 * 接口地址:ip:port/项目名/wxInterface/hRecord/hRecordHirerSubmit
 * @param id
**/
  setLeaseRecordZK (params) {
    return axios.post('/wxInterface/hRecord/hRecordHirerSubmit', qs.stringify({
      id: params.id, 
    })
    )
