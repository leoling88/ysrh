<template>
  <div class="selector_search_box">
    ...
    <div class="address_cont">
      <x-textarea class="textarea" v-model="value" :title="describe" placeholder="请输入街路巷" :autosize="true" :rows="1"></x-textarea>
...
<script>
  import {XInput, XTextarea, Cell, Icon,LoadMore, Scroller, PopupRadio} from 'vux'
  import { mapState } from 'vuex'
  import api from '../../api/api'
  var map,marker,poiPicker;
  export default {
    components: {XInput, XTextarea, Cell,Icon,LoadMore, Scroller,PopupRadio },
    props: {
      describe: { // 描述
        type: String,
        default: ''
    ...
    data() {
      return {
        ...
        marker: '',
        location: [113.3612, 23.12468],
        sourceLocation: [113.3612, 23.12468],
        area: '', // 省市区
...
<style lang="less" scoped>
  ...
  .address_cont{
    ...
    .pos_icon{width:.38rem;height:.46rem;display: block;position: absolute;right:15px;top:50%;margin-top: -.19rem;}
  ...
  .page_silder{transform: translateX(100%);will-change: transform;transition: all 250ms ease-in-out;backface-visibility: hidden;perspective: 1000;}
