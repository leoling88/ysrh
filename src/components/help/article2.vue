<template>
  <div class="QA">
	...
	<div class="con" >
        ...
        <div>
            <img :src="item"  v-for="item in articleImg"/>
<!--             <img :src="'/combile/wxInterface/helpFeedback/fbPicRead?fid=' + item.uuid" v-for="item in articleImg"> -->
        </div>
        <span class="time">反馈时间：{{article.date}}</span>
    </div>
...
import footerBar from '@/components/common/helpNav'
