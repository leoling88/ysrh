<template>
  <div class="QA">
  	...
  	<div class="box-1">
	  	<input type="text" class="text" placeholder="请填写标题" v-model="feedback.title" maxlength="15">
	</div>
	...
	<h2 class="h2">请提供相关问题的截图或照片<span class="right">选中{{upImg.img1.length}}/4</span></h2>
	<div class="box-2">
    ...
    <div @click="goNext" class="but-1">下一步</div>
...
export default {
  directives: {
    ...
    created(){
   //  	let _back = this.$Utils.getLocalStorage('_back');
   //  	if(_back != 'back') {
...
.but-1{width:6rem; margin: 1rem auto .2rem;border-radius:.15rem;padding:.2rem 0;text-align:center;color:#fff;background:#0091FF;}
</style>