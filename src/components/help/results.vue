<template>
  <div class="msg">
  	<div class="img" v-if="resultsData.state == 1"><img class="icon_success" src="../../assets/images/icon_success.png"/></div>
  	<div class="img" v-if="resultsData.state == 2"><img class="icon_success" src="../../assets/images/icon_fail.png"/></div>
