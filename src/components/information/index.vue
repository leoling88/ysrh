          ...
          <div>
            ...
            <div>
              <div v-show="tabitemIndex == 0" class="tabList">
                <div class="news indexNews" v-for="item in lists.list1">
                  <router-link :to="{path:'../article?openId='+ openId +'&id='+ item.id}">
                    <div class="newsCon">
                      <div class="newsTitle">{{item.title}}</div>
                      <div class="newsTime">{{item.sourceName}} {{item.createTime | ellipsis}}</div>
                    </div>
              ...
              <div v-show="tabitemIndex == 1" class="tabList">
                <div class="news indexNews" v-for="item in lists.list2">
                  <router-link :to="{path:'../article?openId='+ openId +'&id='+ item.id}">
                    <div class="newsCon">
                      <div class="newsTitle">{{item.title}}</div>
                      <div class="newsTime">{{item.sourceName}} {{item.createTime | ellipsis}}</div>
              ...
              <div v-show="tabitemIndex == 2" class="tabList">
                <div class="news indexNews" v-for="item in lists.list3">
                  <router-link :to="{path:'../article?openId='+ openId +'&id='+ item.id}">
                    <div class="newsCon">
                      <div class="newsTitle">{{item.title}}</div>
                      <div class="newsTime">{{item.sourceName}} {{item.createTime | ellipsis}}</div>
              ...
              <div v-show="tabitemIndex == 3" class="tabList">
                <div class="news indexNews" v-for="item in lists.list4">
                  <router-link :to="{path:'../article?openId='+ openId +'&id='+ item.id}">
                    <div class="newsCon">
                      <div class="newsTitle">{{item.title}}</div>
                      <div class="newsTime">{{item.sourceName}} {{item.createTime | ellipsis}}</div>
...
import swipers from '@/components/common/swiperone'
export default {
